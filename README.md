...
- Auto ramp: aceleración progresiva de WPM en el tiempo.
...
- Controles compactos en una sola línea horizontal.
...
La interfaz es bilingue (español/inglés) y funciona en desktop y móvil.
...
- Las palabras largas reciben una pequeña penalización de tiempo para mejorar legibilidad.

## Estructura principal

- src/App.tsx: UI, estados y reproducción.
- src/lib/tokenize.ts: normalización y tokenización de texto.
